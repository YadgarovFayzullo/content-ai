...
class TenantProfile(SQLModel, table=True):
    ...
    # Источник картинки: "ai" — ИИ-иллюстрация (по умолчанию), "stock" — чистое
    # тематическое фото из интернета (Pexels) без надписей, "none" — без фото
    # (текстовый пост, ни ИИ, ни сток). Действует и в topic-, и в repost-режиме.
    image_mode: str = "ai"
